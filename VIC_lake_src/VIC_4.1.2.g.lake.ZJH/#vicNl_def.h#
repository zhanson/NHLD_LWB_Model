...
#define OUT_GRND_RECHARGE       155  /* ground water recharge [mm] */ 
#define OUT_GRND_EVAP           156  /* evaporation in the bottom layer [mm] */ 
#define OUT_TOP_EVAP           157  /* evaporation in the Top layer [mm] */ 
#define OUT_VADOSE_EVAP           158  /* evaporation in the vadose layer [mm] */ 
...
typedef struct {
  ...
  double        ground_recharge;   /* ground water recharge [mm] */ 
} save_data_struct;
