...
*************************************************************/
  ...
  strcpy(out_data[OUT_GRND_RECHARGE].varname,"OUT_GRND_RECHARGE");     /* Ground water recharge [mm] */
  strcpy(out_data[OUT_GRND_EVAP].varname,"OUT_GRND_EVAP");             /* Evaporation in bottom layer [mm] */
  strcpy(out_data[OUT_TOP_EVAP].varname,"OUT_TOP_EVAP");             /* Evaporation in top layer [mm] */
  strcpy(out_data[OUT_VADOSE_EVAP].varname,"OUT_VADOSE_EVAP");             /* Evaporation in vadose layer [mm] */
  ...
  out_data[OUT_GRND_RECHARGE].aggtype = AGG_TYPE_SUM;
  out_data[OUT_GRND_EVAP].aggtype = AGG_TYPE_SUM;
  out_data[OUT_TOP_EVAP].aggtype = AGG_TYPE_SUM;
  out_data[OUT_VADOSE_EVAP].aggtype = AGG_TYPE_SUM;
