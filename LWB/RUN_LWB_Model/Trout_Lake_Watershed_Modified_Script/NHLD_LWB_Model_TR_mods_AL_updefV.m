...
%Allequash upper basin, using default volume (Eq 3)
...
%                 V0(kk) = A0(kk)*3.2; %use default volume above and adjusted
%                 perim below for GW fluxes
...
save('LakeModel_MAIN_Rev23_GEN_TR_noSW_BMCRSP_zadj_TB_Vadj_AL_updefV.mat')
